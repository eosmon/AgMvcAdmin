...
namespace AgMvcAdmin.Models
{
    public class ContentCampaign
    {
        ...
        public ContentCampaign(int pgId, int cpId, int psId)
        {
            PageId = pgId;
            CampaignId = cpId;
            PositionId = psId;
        ...
        public ContentCampaign(int cmpId, int delay, string name)
        {
            CampaignId = cmpId;
            ShowDelay = delay;
            CampaignName = name;
        ...
        public ContentCampaign(bool hasCmp, int id, int posId, int ct, int delay, string name)
        {
            HasCampaign = hasCmp;
            Id = id;
            PositionId = posId;
